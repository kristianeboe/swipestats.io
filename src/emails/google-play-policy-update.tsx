        ...
        <Section>
          <Row>
            <Column>
              <Img
                style={headerBlue}
                src={`https://react-email-demo-7h42y6xue-resend.vercel.app/static/google-play-header.png`}
                width="305"
                height="28"
              ...
              <Img
                style={sectionLogo}
                src={`https://react-email-demo-7h42y6xue-resend.vercel.app/static/google-play-logo.png`}
                width="155"
                height="31"
                alt="Google Play"
              />
        ...
        <Section style={containerContact}>
            ...
            <Column style={{ paddingRight: "4px" }}>
              <Link href="https://notifications.google.com">
                <Img
                  width="28"
                  height="28"
                  src={`https://react-email-demo-7h42y6xue-resend.vercel.app/static/google-play-chat.png`}
                />
              </Link>
            </Column>
            <Column style={{ paddingRight: "4px" }}>
              <Link href="https://notifications.google.com">
                <Img
                  width="28"
                  height="28"
                  src={`https://react-email-demo-7h42y6xue-resend.vercel.app/static/google-play-icon.png`}
                />
              </Link>
            </Column>
            <Column style={{ paddingRight: "4px" }}>
              <Link href="https://notifications.google.com">
                <Img
                  width="28"
                  height="28"
                  src={`https://react-email-demo-7h42y6xue-resend.vercel.app/static/google-play-academy.png`}
                />
              </Link>
            </Column>
          </Row>
          <Row>
            <Img
              ...
              width="540"
              height="48"
              src={`https://react-email-demo-7h42y6xue-resend.vercel.app/static/google-play-footer.png`}
            />
          </Row>
        </Section>
