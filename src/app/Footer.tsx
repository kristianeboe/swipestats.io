...
const navigation = {
  ...
  social: [
    ...
    {
      name: "X",
      href: "https://twitter.com/swipestatsio",
      icon: () => (
        <svg
          fill="currentColor"
          viewBox="0 0 24 24"
    ...
    {
      name: "Reddit",
      href: "https://www.reddit.com/r/swipestats/",
      icon: () => (
        <svg
          fill="currentColor"
          viewBox="0 0 24 24"
  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs font-bold leading-5 text-gray-500">
          Made with 🔥 in Norway by{" "}
          <Link target="_blank" href="https://instagram.com/kristianeboe">
            @kristianeboe
          </Link>
        </p>
