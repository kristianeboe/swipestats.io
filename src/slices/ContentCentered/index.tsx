...
export type ContentCenteredProps =
  SliceComponentProps<Content.ContentCenteredSlice>;

/**
 * Component for "ContentCentered" Slices.
 */
const ContentCentered = ({ slice }: ContentCenteredProps): JSX.Element => {
  return (
    <section
    ...
    >
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <p className="mt-6 text-xl leading-8">{slice.primary.intro}</p>
