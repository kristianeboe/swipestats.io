...
/**
 * Props for `ContentWithTestimonialsAndStats`.
 */
export type ContentWithTestimonialsAndStatsProps =
  SliceComponentProps<Content.ContentWithTestimonialsAndStatsSlice>;

/**
 * Component for "ContentWithTestimonialsAndStats" Slices.
 */
const ContentWithTestimonialsAndStats = ({
  slice,
}: ContentWithTestimonialsAndStatsProps): JSX.Element => {
  console.log("ContentWithTestimonialsAndStats", slice.primary);
  return (
    <section
    ...
    >
      <div>
        Placeholder component for content_with_testimonials_and_stats
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                ...
                <figure className="relative isolate">
                  ...
                  <blockquote className="mt-6 text-xl font-semibold leading-8 text-white">
                    <p>“{slice.primary.testimonial_quote}”</p>
                  </blockquote>
                  <figcaption className="mt-6 text-sm leading-6 text-gray-300">
                    <strong className="font-semibold text-white">
                      {slice.primary.testimonial_name},
                    </strong>{" "}
                    {slice.primary.testimonial_title}
                  </figcaption>
                </figure>
              </div>
            </div>
...
export default ContentWithTestimonialsAndStats;
